...
@Component({
  selector: 'app-doodle-properties',
  templateUrl: './doodle-properties.component.html',
  styleUrls: ['./doodle-properties.component.css']
})
export class DoodlePropertiesComponent implements OnInit {
  ...
  ngOnInit() {
    this.shape = this.editorService.selectedShape as Doodle;
    this.setFieldValues();
  }
